...
.field private grsInterceptor:Lcom/huawei/hms/framework/network/grs/e;
...
.method public getInterceptor()Lcom/huawei/hms/framework/network/restclient/hwhttp/plugin/PluginInterceptor;
    ...
    iget-object v0, p0, Lcom/huawei/hms/framework/network/grs/GrsManager;->grsInterceptor:Lcom/huawei/hms/framework/network/grs/e;

    if-nez v0, :cond_0

    new-instance v0, Lcom/huawei/hms/framework/network/grs/e;

    invoke-direct {v0}, Lcom/huawei/hms/framework/network/grs/e;-><init>()V

    iput-object v0, p0, Lcom/huawei/hms/framework/network/grs/GrsManager;->grsInterceptor:Lcom/huawei/hms/framework/network/grs/e;
...
.method public initGrs(Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/GrsConfig;)Z
    ...
    :cond_1
    iget-object p2, p0, Lcom/huawei/hms/framework/network/grs/GrsManager;->grsConfig:Lcom/huawei/hms/framework/network/grs/GrsConfig;

    if-eqz p2, :cond_2

    invoke-virtual {p2, p1}, Lcom/huawei/hms/framework/network/grs/GrsConfig;->getGrsBaseInfo(Landroid/content/Context;)Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;
