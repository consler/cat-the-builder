...
.field private e:Lcom/huawei/hms/framework/network/grs/b/h;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/huawei/hms/framework/network/grs/a/a;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/huawei/hms/framework/network/grs/a/a;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lcom/huawei/hms/framework/network/grs/a/c;Lcom/huawei/hms/framework/network/grs/b/h;)V
    .locals 2
    ...
    iput-object p2, p0, Lcom/huawei/hms/framework/network/grs/a/a;->e:Lcom/huawei/hms/framework/network/grs/b/h;

    invoke-virtual {p2, p0}, Lcom/huawei/hms/framework/network/grs/b/h;->a(Lcom/huawei/hms/framework/network/grs/a/a;)V
...
.method private a(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Lcom/huawei/hms/framework/network/grs/a/b;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/huawei/hms/framework/network/grs/c/e;->a(Ljava/lang/Long;)Z
    ...
    invoke-static {v0, v2, v3}, Lcom/huawei/hms/framework/network/grs/c/e;->a(Ljava/lang/Long;J)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/huawei/hms/framework/network/grs/a/a;->e:Lcom/huawei/hms/framework/network/grs/b/h;

    const/4 v2, 0x0

    invoke-virtual {v0, p1, p3, v2, p4}, Lcom/huawei/hms/framework/network/grs/b/h;->a(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/b;Ljava/lang/String;)V
...
.method private a(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Ljava/lang/String;Landroid/content/Context;)V
    ...
    invoke-static {p2, v0, v1}, Lcom/huawei/hms/framework/network/grs/c/e;->a(Ljava/lang/Long;J)Z

    move-result p2

    if-eqz p2, :cond_0

    iget-object p2, p0, Lcom/huawei/hms/framework/network/grs/a/a;->e:Lcom/huawei/hms/framework/network/grs/b/h;

    const/4 v0, 0x0

    invoke-virtual {p2, p1, p3, v0, v0}, Lcom/huawei/hms/framework/network/grs/b/h;->a(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/b;Ljava/lang/String;)V
...
.method public a(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Lcom/huawei/hms/framework/network/grs/b/d;Landroid/content/Context;)V
    .locals 2

    invoke-virtual {p2}, Lcom/huawei/hms/framework/network/grs/b/d;->f()I
    ...
    invoke-virtual {p2}, Lcom/huawei/hms/framework/network/grs/b/d;->c()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p3, p1, v0}, Lcom/huawei/hms/framework/network/grs/a/c;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lcom/huawei/hms/framework/network/grs/b/d;->d()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p3, v0, v1}, Lcom/huawei/hms/framework/network/grs/a/c;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/huawei/hms/framework/network/grs/a;->a(Ljava/lang/String;)Ljava/util/Map;
...
.method public b(Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, p1}, Lcom/huawei/hms/framework/network/grs/b/h;->a(Ljava/lang/String;)V
