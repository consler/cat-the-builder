...
.method private processBitmap(Landroid/graphics/Bitmap;I)V
    ...
    invoke-virtual {v1, p2, v0, v2}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
...
.method performBitmapTransformed(J)V
    ...
    .line 106
    iget v2, p0, Lcom/squareup/picasso/Stats;->originalBitmapCount:I

    invoke-static {v2, v0, v1}, Lcom/squareup/picasso/Stats;->getAverage(IJ)J
...
.method performDownloadFinished(Ljava/lang/Long;)V
    ...
    .line 94
    iget v2, p0, Lcom/squareup/picasso/Stats;->downloadCount:I
