...
.method public onCompleted(Ljava/lang/Exception;Lcom/koushikdutta/async/http/Headers;)V
    ...
    .line 433
    iget-object v0, p0, Lcom/koushikdutta/async/http/spdy/SpdyMiddleware$5;->val$spdySocket:Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection$SpdySocket;

    invoke-virtual {v0}, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection$SpdySocket;->getConnection()Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;

    move-result-object v1

    iget-object v1, v1, Lcom/koushikdutta/async/http/spdy/AsyncSpdyConnection;->protocol:Lcom/koushikdutta/async/http/Protocol;

    const/4 v2, 0x0

    invoke-static {v0, v1, p2, v2}, Lcom/koushikdutta/async/http/HttpUtil;->getBodyDecoder(Lcom/koushikdutta/async/DataEmitter;Lcom/koushikdutta/async/http/Protocol;Lcom/koushikdutta/async/http/Headers;Z)Lcom/koushikdutta/async/DataEmitter;
