...
.method public final run()V
    ...
    .line 19
    .local v0, "$i$a$-Runnable-TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$1":I
    iget-object v1, p0, Lkotlinx/coroutines/test/TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1;->$continuation$inlined:Lkotlinx/coroutines/CancellableContinuation;

    .line 20
    .local v1, "$this$with":Lkotlinx/coroutines/CancellableContinuation;
    const/4 v2, 0x0

    .line 19
    .local v2, "$i$a$-with-TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$1$1":I
    iget-object v3, p0, Lkotlinx/coroutines/test/TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1;->this$0:Lkotlinx/coroutines/test/TestCoroutineContext$Dispatcher;
    ...
    .line 21
    .end local v0    # "$i$a$-Runnable-TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$1":I
    .end local v1    # "$this$with":Lkotlinx/coroutines/CancellableContinuation;
    .end local v2    # "$i$a$-with-TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$1$1":I
    return-void
.end method
