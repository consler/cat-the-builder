...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v6, "values":Lkotlin/jvm/internal/Ref$ObjectRef;
    const/4 v7, 0x0
    ...
    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$5:Ljava/lang/Object;

    check-cast v9, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$4:Ljava/lang/Object;

    move-object v5, v9

    check-cast v5, Lkotlinx/coroutines/channels/ReceiveChannel;

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$3:Ljava/lang/Object;

    move-object v4, v9

    check-cast v4, Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$2:Ljava/lang/Object;

    move-object v6, v9

    check-cast v6, Lkotlin/jvm/internal/Ref$ObjectRef;

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$1:Ljava/lang/Object;

    move-object v8, v9

    check-cast v8, Lkotlinx/coroutines/flow/FlowCollector;

    iget-object v9, v1, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$0:Ljava/lang/Object;
    ...
    .end local v6    # "values":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    new-instance v5, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$values$1;

    invoke-direct {v5, v1, v4}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$values$1;-><init>(Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;Lkotlin/coroutines/Continuation;)V
    ...
    .line 285
    .local v12, "values":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .local v11, "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    .local v12, "ticker":Lkotlinx/coroutines/channels/ReceiveChannel;
    .local v14, "values":Lkotlin/jvm/internal/Ref$ObjectRef;
    ...
    .line 355
    iput-object v5, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$0:Ljava/lang/Object;

    iput-object v15, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$1:Ljava/lang/Object;

    iput-object v14, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$2:Ljava/lang/Object;

    iput-object v13, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$3:Ljava/lang/Object;

    iput-object v12, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$4:Ljava/lang/Object;

    iput-object v11, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->L$5:Ljava/lang/Object;

    iput v3, v11, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;->label:I
    ...
    .line 357
    .local v9, "scope$iv":Lkotlinx/coroutines/selects/SelectBuilderImpl;
    nop
    ...
    .line 289
    .local v18, "$i$a$-select-FlowKt__DelayKt$sample$2$1":I
    ...
    new-instance v19, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$invokeSuspend$$inlined$select$lambda$1;
    :try_end_0
    ...
    .end local v9    # "scope$iv":Lkotlinx/coroutines/selects/SelectBuilderImpl;
    ...
    .end local v11    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    .local v22, "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    move-object v11, v15

    :try_start_1
    invoke-direct/range {v6 .. v11}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$invokeSuspend$$inlined$select$lambda$1;-><init>(Lkotlin/coroutines/Continuation;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlinx/coroutines/flow/FlowCollector;)V
    ...
    .line 299
    invoke-interface {v12}, Lkotlinx/coroutines/channels/ReceiveChannel;->getOnReceive()Lkotlinx/coroutines/selects/SelectClause1;

    move-result-object v3

    new-instance v19, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$invokeSuspend$$inlined$select$lambda$2;
    ...
    invoke-direct/range {v6 .. v11}, Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$invokeSuspend$$inlined$select$lambda$2;-><init>(Lkotlin/coroutines/Continuation;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlinx/coroutines/flow/FlowCollector;)V
    ...
    .end local v18    # "$i$a$-select-FlowKt__DelayKt$sample$2$1":I
    ...
    .end local v22    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    .restart local v9    # "scope$iv":Lkotlinx/coroutines/selects/SelectBuilderImpl;
    .restart local v10    # "uCont$iv":Lkotlin/coroutines/Continuation;
    .restart local v11    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    :catchall_1
    move-exception v0
    ...
    .restart local v22    # "this":Lkotlinx/coroutines/flow/FlowKt__DelayKt$sample$2;
    :goto_1
    move-object/from16 v3, v20
    ...
    .line 306
    .end local v12    # "ticker":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local v13    # "lastValue":Lkotlin/jvm/internal/Ref$ObjectRef;
    .end local v14    # "values":Lkotlin/jvm/internal/Ref$ObjectRef;
    :cond_4
