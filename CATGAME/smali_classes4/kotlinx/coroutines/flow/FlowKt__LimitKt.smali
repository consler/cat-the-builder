...
.method public static final collectWhile(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->result:Ljava/lang/Object;
    ...
    .line 127
    iget v3, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->label:I
    ...
    .local v2, "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    const/4 v3, 0x0

    .local v3, "$i$f$collectWhile":I
    iget-object v4, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->L$2:Ljava/lang/Object;

    move-object v2, v4

    check-cast v2, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;

    iget-object v4, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->L$1:Ljava/lang/Object;

    move-object p1, v4

    check-cast p1, Lkotlin/jvm/functions/Function2;

    iget-object v4, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    ...
    new-instance v5, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;

    invoke-direct {v5, p1}, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;-><init>(Lkotlin/jvm/functions/Function2;)V

    .line 137
    .local v5, "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    nop
    ...
    iput-object v5, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->L$2:Ljava/lang/Object;

    iput v4, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$1;->label:I

    invoke-interface {p0, v6, v0}, Lkotlinx/coroutines/flow/Flow;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .end local v5    # "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    .restart local v2    # "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    :goto_1
    goto :goto_3

    .line 139
    .end local v2    # "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    .restart local v5    # "collector":Lkotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1;
    :catch_1
    move-exception v4
...
.method private static final collectWhile$$forInline(Lkotlinx/coroutines/flow/Flow;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 140
    .local p2, "e":Lkotlinx/coroutines/flow/internal/AbortFlowException;
    move-object v2, v1

    check-cast v2, Lkotlinx/coroutines/flow/FlowCollector;

    invoke-static {p2, v2}, Lkotlinx/coroutines/flow/internal/FlowExceptions_commonKt;->checkOwnership(Lkotlinx/coroutines/flow/internal/AbortFlowException;Lkotlinx/coroutines/flow/FlowCollector;)V

    .line 141
    .end local p2    # "e":Lkotlinx/coroutines/flow/internal/AbortFlowException;
    :goto_0
    nop
...
.method static final synthetic emitAbort$FlowKt__LimitKt(Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 5
    .param p0, "$this$emitAbort"    # Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local v0, "$continuation":Lkotlin/coroutines/Continuation;
    :goto_0
    iget-object v1, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$emitAbort$1;->result:Ljava/lang/Object;
    ...
    .line 72
    iget v3, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$emitAbort$1;->label:I
    ...
    .restart local v1    # "$result":Ljava/lang/Object;
    :cond_1
    iget-object p1, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$emitAbort$1;->L$1:Ljava/lang/Object;

    iget-object v2, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$emitAbort$1;->L$0:Ljava/lang/Object;
    ...
    iput v4, v0, Lkotlinx/coroutines/flow/FlowKt__LimitKt$emitAbort$1;->label:I
    ...
    invoke-direct {v2, p0}, Lkotlinx/coroutines/flow/internal/AbortFlowException;-><init>(Lkotlinx/coroutines/flow/FlowCollector;)V
