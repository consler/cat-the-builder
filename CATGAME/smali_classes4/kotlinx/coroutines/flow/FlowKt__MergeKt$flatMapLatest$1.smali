...
.method public final create(Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iput-object p1, v0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->p$:Lkotlinx/coroutines/flow/FlowCollector;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->create(Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;

    sget-object p2, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    move-object v2, v4

    .local v2, "it":Ljava/lang/Object;
    const/4 v3, 0x0

    .local v3, "$i$f$emitAll":I
    .local v4, "flow$iv":Lkotlinx/coroutines/flow/Flow;
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$3:Ljava/lang/Object;

    move-object v4, v5

    check-cast v4, Lkotlinx/coroutines/flow/Flow;

    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$2:Ljava/lang/Object;

    move-object v1, v5

    check-cast v1, Lkotlinx/coroutines/flow/FlowCollector;

    iget-object v2, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$1:Ljava/lang/Object;

    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    .end local v2    # "it":Ljava/lang/Object;
    .end local v3    # "$i$f$emitAll":I
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$2:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->p$:Lkotlinx/coroutines/flow/FlowCollector;

    .local v4, "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    iget-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->p$0:Ljava/lang/Object;

    .local v1, "it":Ljava/lang/Object;
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->$transform:Lkotlin/jvm/functions/Function2;

    iput-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$0:Ljava/lang/Object;

    iput-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$1:Ljava/lang/Object;

    iput-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$2:Ljava/lang/Object;
    ...
    iput-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$2:Ljava/lang/Object;

    iput-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->L$3:Ljava/lang/Object;
...
.method public final invokeSuspend$$forInline(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;->p$:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local v3, "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    const/4 v4, 0x0
    ...
    .end local v3    # "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
