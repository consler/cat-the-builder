...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->create(Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v2, "$i$f$emitAll":I
    move-object v3, v4

    .local v3, "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    .local v4, "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$3:Ljava/lang/Object;

    move-object v0, v5

    check-cast v0, Lkotlinx/coroutines/flow/Flow;

    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$2:Ljava/lang/Object;
    ...
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "$i$f$emitAll":I
    .end local v3    # "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    .end local v4    # "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    :cond_0
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$2:Ljava/lang/Object;
    ...
    iget-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->p$:Lkotlinx/coroutines/flow/FlowCollector;

    .local v4, "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    iget-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->p$0:Ljava/lang/Object;

    .line 190
    .restart local v1    # "it":Ljava/lang/Object;
    iget-object v5, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->$transform:Lkotlin/jvm/functions/Function2;

    iput-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$0:Ljava/lang/Object;

    iput-object v1, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$1:Ljava/lang/Object;

    iput-object v4, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$2:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lkotlinx/coroutines/flow/FlowKt__MigrationKt$switchMap$$inlined$flatMapLatest$1;->L$3:Ljava/lang/Object;
    ...
    .restart local v0    # "flow$iv":Lkotlinx/coroutines/flow/Flow;
    .restart local v2    # "$i$f$emitAll":I
    .local v3, "$this$transformLatest":Lkotlinx/coroutines/flow/FlowCollector;
    .local v4, "$this$emitAll$iv":Lkotlinx/coroutines/flow/FlowCollector;
    :goto_1
