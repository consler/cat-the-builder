...
.method public emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->result:Ljava/lang/Object;
    ...
    .line 158
    iget v3, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->label:I
    ...
    .local v3, "count":I
    .local v4, "$i$a$-collect-StartedLazily$command$1$1":I
    iget v3, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->I$0:I

    iget-object v5, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->L$2:Ljava/lang/Object;
    ...
    iget-object v5, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->L$0:Ljava/lang/Object;

    check-cast v5, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;

    .end local p0    # "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    .local v5, "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    ...
    .end local v4    # "$i$a$-collect-StartedLazily$command$1$1":I
    .end local v5    # "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    .restart local p0    # "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    :cond_1
    ...
    .line 133
    .local v6, "$i$a$-collect-StartedLazily$command$1$1":I
    if-lez v5, :cond_4

    iget-object v7, p0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;->$started$inlined:Lkotlin/jvm/internal/Ref$BooleanRef;
    ...
    .line 135
    iget-object v7, p0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;->$this_flow$inlined:Lkotlinx/coroutines/flow/FlowCollector;

    sget-object v8, Lkotlinx/coroutines/flow/SharingCommand;->START:Lkotlinx/coroutines/flow/SharingCommand;
    ...
    iput-object v3, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->L$2:Ljava/lang/Object;

    iput v5, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->I$0:I

    iput v4, v0, Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1$1;->label:I
    ...
    .line 137
    .end local v6    # "$i$a$-collect-StartedLazily$command$1$1":I
    .end local p0    # "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    .restart local v2    # "continuation":Lkotlin/coroutines/Continuation;
    .local v3, "count":I
    .restart local v4    # "$i$a$-collect-StartedLazily$command$1$1":I
    .local v5, "this":Lkotlinx/coroutines/flow/StartedLazily$command$1$invokeSuspend$$inlined$collect$1;
    :goto_1
    move v6, v4
    ...
    .local v3, "continuation":Lkotlin/coroutines/Continuation;
    .local v5, "count":I
    .restart local v6    # "$i$a$-collect-StartedLazily$command$1$1":I
    :cond_4
    move-object v2, p0
