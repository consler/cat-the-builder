...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "scopeContext":Lkotlin/coroutines/CoroutineContext;
    move-object v1, v10
    ...
    .local v3, "cnt":Ljava/lang/Object;
    move-object v4, v10

    .local v4, "collectJob":Lkotlinx/coroutines/CompletableJob;
    iget-object v3, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$4:Ljava/lang/Object;

    iget-object v5, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$3:Ljava/lang/Object;

    move-object v0, v5

    check-cast v0, Lkotlin/coroutines/CoroutineContext;

    iget-object v5, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$2:Ljava/lang/Object;

    move-object v4, v5

    check-cast v4, Lkotlinx/coroutines/CompletableJob;

    iget-object v5, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$1:Ljava/lang/Object;

    move-object v1, v5

    check-cast v1, Lkotlinx/coroutines/channels/ReceiveChannel;

    iget-object v5, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$0:Ljava/lang/Object;
    ...
    .line 141
    .end local v0    # "scopeContext":Lkotlin/coroutines/CoroutineContext;
    .end local v3    # "cnt":Ljava/lang/Object;
    :catchall_0
    move-exception v0
    ...
    .end local v4    # "collectJob":Lkotlinx/coroutines/CompletableJob;
    :cond_0
    ...
    .line 108
    .local v12, "second":Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    .line 109
    .local v13, "collectJob":Lkotlinx/coroutines/CompletableJob;
    if-eqz v12, :cond_5
    ...
    invoke-direct {v2, v8, v13}, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1$2;-><init>(Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;Lkotlinx/coroutines/CompletableJob;)V
    ...
    iput-object v13, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$2:Ljava/lang/Object;

    iput-object v14, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$3:Ljava/lang/Object;

    iput-object v15, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->L$4:Ljava/lang/Object;
    ...
    .end local v12    # "second":Lkotlinx/coroutines/channels/ReceiveChannel;
    .end local v13    # "collectJob":Lkotlinx/coroutines/CompletableJob;
    .end local v14    # "scopeContext":Lkotlin/coroutines/CoroutineContext;
    .end local v15    # "cnt":Ljava/lang/Object;
    .restart local v0    # "scopeContext":Lkotlin/coroutines/CoroutineContext;
    .restart local v1    # "second":Lkotlinx/coroutines/channels/ReceiveChannel;
    .restart local v2    # "$this$coroutineScope":Lkotlinx/coroutines/CoroutineScope;
    .restart local v3    # "cnt":Ljava/lang/Object;
    .restart local v4    # "collectJob":Lkotlinx/coroutines/CompletableJob;
    :goto_0
    nop
    ...
    .end local v2    # "$this$coroutineScope":Lkotlinx/coroutines/CoroutineScope;
    .end local v4    # "collectJob":Lkotlinx/coroutines/CompletableJob;
    .restart local v11    # "$this$coroutineScope":Lkotlinx/coroutines/CoroutineScope;
    .restart local v12    # "second":Lkotlinx/coroutines/channels/ReceiveChannel;
    .restart local v13    # "collectJob":Lkotlinx/coroutines/CompletableJob;
    :catchall_1
    move-exception v0
    ...
    :goto_2
    :try_start_2
    iget-object v3, v8, Lkotlinx/coroutines/flow/internal/CombineKt$zipImpl$$inlined$unsafeFlow$1$lambda$1;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
