...
.method public openURI(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Lcom/badlogic/gdx/backends/android/AndroidNet;->app:Lcom/badlogic/gdx/backends/android/AndroidApplicationBase;

    invoke-interface {v3}, Lcom/badlogic/gdx/backends/android/AndroidApplicationBase;->getContext()Landroid/content/Context;
    ...
    invoke-direct {v5, p0, v1}, Lcom/badlogic/gdx/backends/android/AndroidNet$1;-><init>(Lcom/badlogic/gdx/backends/android/AndroidNet;Landroid/net/Uri;)V
