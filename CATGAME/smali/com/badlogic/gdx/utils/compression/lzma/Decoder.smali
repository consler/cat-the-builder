...
.method public Code(Ljava/io/InputStream;Ljava/io/OutputStream;J)Z
    ...
    invoke-virtual {v3, v12, v7}, Lcom/badlogic/gdx/utils/compression/lzma/Decoder$LiteralDecoder;->GetDecoder(IB)Lcom/badlogic/gdx/utils/compression/lzma/Decoder$LiteralDecoder$Decoder2;
    ...
    invoke-static {v7, v4, v13, v11}, Lcom/badlogic/gdx/utils/compression/rangecoder/BitTreeDecoder;->ReverseDecode([SILcom/badlogic/gdx/utils/compression/rangecoder/Decoder;I)I
    ...
    invoke-virtual {v3, v10, v13}, Lcom/badlogic/gdx/utils/compression/lz/OutWindow;->CopyBlock(II)V
