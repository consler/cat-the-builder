...
.method public generate()Landroidx/palette/graphics/Palette;
    ...
    .line 797
    invoke-direct {p0, v1}, Landroidx/palette/graphics/Palette$Builder;->scaleBitmapDown(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 803
    :cond_0
    iget-object v2, p0, Landroidx/palette/graphics/Palette$Builder;->mRegion:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/palette/graphics/Palette$Builder;->mBitmap:Landroid/graphics/Bitmap;
    ...
    .line 818
    invoke-direct {p0, v1}, Landroidx/palette/graphics/Palette$Builder;->getPixelsFromBitmap(Landroid/graphics/Bitmap;)[I

    move-result-object v4

    iget v5, p0, Landroidx/palette/graphics/Palette$Builder;->mMaxColors:I
    ...
    :goto_0
    invoke-direct {v3, v4, v5, v6}, Landroidx/palette/graphics/ColorCutQuantizer;-><init>([II[Landroidx/palette/graphics/Palette$Filter;)V

    .line 823
    .local v3, "quantizer":Landroidx/palette/graphics/ColorCutQuantizer;
    iget-object v4, p0, Landroidx/palette/graphics/Palette$Builder;->mBitmap:Landroid/graphics/Bitmap;
    ...
    .line 827
    :cond_3
    invoke-virtual {v3}, Landroidx/palette/graphics/ColorCutQuantizer;->getQuantizedColors()Ljava/util/List;

    move-result-object v4

    .line 829
    .local v4, "swatches":Ljava/util/List;, "Ljava/util/List<Landroidx/palette/graphics/Palette$Swatch;>;"
    if-eqz v0, :cond_4
    ...
    .end local v3    # "quantizer":Landroidx/palette/graphics/ColorCutQuantizer;
    :cond_4
    goto :goto_1

    .end local v4    # "swatches":Ljava/util/List;, "Ljava/util/List<Landroidx/palette/graphics/Palette$Swatch;>;"
    :cond_5
    iget-object v1, p0, Landroidx/palette/graphics/Palette$Builder;->mSwatches:Ljava/util/List;

    if-eqz v1, :cond_7

    .line 834
    iget-object v4, p0, Landroidx/palette/graphics/Palette$Builder;->mSwatches:Ljava/util/List;

    .line 841
    .restart local v4    # "swatches":Ljava/util/List;, "Ljava/util/List<Landroidx/palette/graphics/Palette$Swatch;>;"
    :goto_1
    ...
    invoke-direct {v1, v4, v2}, Landroidx/palette/graphics/Palette;-><init>(Ljava/util/List;Ljava/util/List;)V
