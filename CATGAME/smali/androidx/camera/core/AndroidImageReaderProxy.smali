...
.method public declared-synchronized acquireLatestImage()Landroidx/camera/core/ImageProxy;
    ...
    .end local p0    # "this":Landroidx/camera/core/AndroidImageReaderProxy;
    :catchall_0
    move-exception v0
    ...
    :try_start_1
    invoke-direct {p0, v0}, Landroidx/camera/core/AndroidImageReaderProxy;->isImageReaderContextNotInitializedException(Ljava/lang/RuntimeException;)Z
    ...
    invoke-direct {v1, v0}, Landroidx/camera/core/AndroidImageProxy;-><init>(Landroid/media/Image;)V
    :try_end_2
...
.method public synthetic lambda$setOnImageAvailableListener$1$AndroidImageReaderProxy(Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/ImageReaderProxy$OnImageAvailableListener;Landroid/media/ImageReader;)V
    ...
    .line 139
    new-instance v0, Landroidx/camera/core/-$$Lambda$AndroidImageReaderProxy$RyV51268LxqXqf_5yS6H_QoqpDY;

    invoke-direct {v0, p0, p2}, Landroidx/camera/core/-$$Lambda$AndroidImageReaderProxy$RyV51268LxqXqf_5yS6H_QoqpDY;-><init>(Landroidx/camera/core/AndroidImageReaderProxy;Landroidx/camera/core/impl/ImageReaderProxy$OnImageAvailableListener;)V
...
.method public declared-synchronized setOnImageAvailableListener(Landroidx/camera/core/impl/ImageReaderProxy$OnImageAvailableListener;Ljava/util/concurrent/Executor;)V
    ...
    .line 138
    :try_start_0
    new-instance v0, Landroidx/camera/core/-$$Lambda$AndroidImageReaderProxy$1j5V93NALzdEKViOyKnqPUbnDDk;

    invoke-direct {v0, p0, p2, p1}, Landroidx/camera/core/-$$Lambda$AndroidImageReaderProxy$1j5V93NALzdEKViOyKnqPUbnDDk;-><init>(Landroidx/camera/core/AndroidImageReaderProxy;Ljava/util/concurrent/Executor;Landroidx/camera/core/impl/ImageReaderProxy$OnImageAvailableListener;)V

    .line 140
    .local v0, "transformedListener":Landroid/media/ImageReader$OnImageAvailableListener;
    ...
    .line 137
    .end local v0    # "transformedListener":Landroid/media/ImageReader$OnImageAvailableListener;
    .end local p0    # "this":Landroidx/camera/core/AndroidImageReaderProxy;
    .end local p1    # "listener":Landroidx/camera/core/impl/ImageReaderProxy$OnImageAvailableListener;
