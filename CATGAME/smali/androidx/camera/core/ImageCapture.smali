...
.method constructor <init>(Landroidx/camera/core/impl/ImageCaptureConfig;)V
    ...
    .line 265
    sget-object v0, Landroidx/camera/core/-$$Lambda$ImageCapture$-NPEX6f-pK2w8zMZHH6SI-c-xrU;->INSTANCE:Landroidx/camera/core/-$$Lambda$ImageCapture$-NPEX6f-pK2w8zMZHH6SI-c-xrU;
    ...
    iput-object v0, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;
    ...
    invoke-virtual {v0}, Landroidx/camera/core/impl/ImageCaptureConfig;->getFlashMode()I
    ...
    invoke-virtual {v0, v2}, Landroidx/camera/core/impl/ImageCaptureConfig;->getCaptureProcessor(Landroidx/camera/core/impl/CaptureProcessor;)Landroidx/camera/core/impl/CaptureProcessor;

    move-result-object v0

    iput-object v0, p0, Landroidx/camera/core/ImageCapture;->mCaptureProcessor:Landroidx/camera/core/impl/CaptureProcessor;
    ...
    invoke-virtual {v0, v2}, Landroidx/camera/core/impl/ImageCaptureConfig;->getMaxCaptureStages(I)I

    move-result v0

    iput v0, p0, Landroidx/camera/core/ImageCapture;->mMaxCaptureStages:I
    ...
    .line 303
    invoke-virtual {v0, v3}, Landroidx/camera/core/impl/ImageCaptureConfig;->getCaptureBundle(Landroidx/camera/core/impl/CaptureBundle;)Landroidx/camera/core/impl/CaptureBundle;
    ...
    invoke-virtual {v0, v3}, Landroidx/camera/core/impl/ImageCaptureConfig;->getIoExecutor(Ljava/util/concurrent/Executor;)Ljava/util/concurrent/Executor;
    ...
    .line 316
    .local v0, "captureBuilder":Landroidx/camera/core/impl/CaptureConfig$Builder;
...
.method private getCaptureBundle(Landroidx/camera/core/impl/CaptureBundle;)Landroidx/camera/core/impl/CaptureBundle;
    .locals 2
    .param p1, "defaultCaptureBundle"    # Landroidx/camera/core/impl/CaptureBundle;
    ...
    .line 1333
    .local v0, "captureStages":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureStage;>;"
    if-eqz v0, :cond_1
...
.method static getError(Ljava/lang/Throwable;)I
    ...
    .line 1001
    :cond_0
    instance-of v0, p0, Landroidx/camera/core/ImageCapture$CaptureFailedException;
...
.method static synthetic lambda$preTakePicture$12(Ljava/lang/Boolean;)Ljava/lang/Void;
    .locals 1
    .param p0, "is3AConverged"    # Ljava/lang/Boolean;
...
.method static synthetic lambda$takePictureInternal$6(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;Landroidx/camera/core/impl/ImageReaderProxy;)V
    ...
    const-string v2, "Unable to acquire image"
...
.method private preTakePicture(Landroidx/camera/core/ImageCapture$TakePictureState;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .param p1, "state"    # Landroidx/camera/core/ImageCapture$TakePictureState;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/camera/core/ImageCapture$TakePictureState;",
    ...
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$cx3bPsi9G7LL_QgL8vl6Pua6Yyo;

    invoke-direct {v1, p0, p1}, Landroidx/camera/core/-$$Lambda$ImageCapture$cx3bPsi9G7LL_QgL8vl6Pua6Yyo;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$TakePictureState;)V
    ...
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$qxiP-lEMHbynOHrJ3C0Tk0bLYJQ;

    invoke-direct {v1, p0, p1}, Landroidx/camera/core/-$$Lambda$ImageCapture$qxiP-lEMHbynOHrJ3C0Tk0bLYJQ;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$TakePictureState;)V
    ...
    sget-object v1, Landroidx/camera/core/-$$Lambda$ImageCapture$qrLn_XI1j1x4jhqRvP925EZ_Pc0;->INSTANCE:Landroidx/camera/core/-$$Lambda$ImageCapture$qrLn_XI1j1x4jhqRvP925EZ_Pc0;
...
.method private sendImageCaptureRequest(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
    ...
    .line 734
    .local v0, "attachedCamera":Landroidx/camera/core/impl/CameraInternal;
    if-nez v0, :cond_0

    .line 736
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$pBXp0PTu2y8W2MYKbHOK5lMiVKg;

    invoke-direct {v1, p0, p2}, Landroidx/camera/core/-$$Lambda$ImageCapture$pBXp0PTu2y8W2MYKbHOK5lMiVKg;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
    ...
    iget-object v2, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;

    const/4 v3, 0x0

    .line 744
    invoke-virtual {v2, v3}, Landroidx/camera/core/impl/ImageCaptureConfig;->getTargetRotation(I)I
    ...
    .line 746
    .local v2, "relativeRotation":I
    iget-object v3, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Landroidx/camera/core/impl/ImageCaptureConfig;->getTargetAspectRatioCustom(Landroid/util/Rational;)Landroid/util/Rational;

    move-result-object v10

    .line 748
    .local v10, "targetRatio":Landroid/util/Rational;
    iget-object v11, p0, Landroidx/camera/core/ImageCapture;->mImageCaptureRequestProcessor:Landroidx/camera/core/ImageCapture$ImageCaptureRequestProcessor;

    new-instance v12, Landroidx/camera/core/ImageCapture$ImageCaptureRequest;
    ...
    .line 748
    invoke-virtual {v11, v12}, Landroidx/camera/core/ImageCapture$ImageCaptureRequestProcessor;->sendRequest(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)V
...
.method private takePictureInternal(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 786
    new-instance v0, Landroidx/camera/core/-$$Lambda$ImageCapture$Yn9me8_Get6e1Qr4IQRhjwwSXbs;

    invoke-direct {v0, p0, p1}, Landroidx/camera/core/-$$Lambda$ImageCapture$Yn9me8_Get6e1Qr4IQRhjwwSXbs;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)V
...
.method private triggerAf(Landroidx/camera/core/ImageCapture$TakePictureState;)V
    ...
    .line 1193
    .local v0, "future":Lcom/google/common/util/concurrent/ListenableFuture;, "Lcom/google/common/util/concurrent/ListenableFuture<Landroidx/camera/core/impl/CameraCaptureResult;>;"
    sget-object v1, Landroidx/camera/core/-$$Lambda$ImageCapture$imelcLeIMea3rxGpuBTI2wHdPNQ;->INSTANCE:Landroidx/camera/core/-$$Lambda$ImageCapture$imelcLeIMea3rxGpuBTI2wHdPNQ;
...
.method check3AConverged(Landroidx/camera/core/ImageCapture$TakePictureState;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v2, Landroidx/camera/core/ImageCapture$7;

    invoke-direct {v2, p0}, Landroidx/camera/core/ImageCapture$7;-><init>(Landroidx/camera/core/ImageCapture;)V
    ...
    .line 1123
    invoke-virtual {v0, v2, v3, v4, v1}, Landroidx/camera/core/ImageCapture$CaptureCallbackChecker;->checkCaptureResult(Landroidx/camera/core/ImageCapture$CaptureCallbackChecker$CaptureResultChecker;JLjava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method createPipeline(Ljava/lang/String;Landroidx/camera/core/impl/ImageCaptureConfig;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$Builder;
    ...
    .line 350
    .local v1, "metadataImageReader":Landroidx/camera/core/MetadataImageReader;
    ...
    .line 353
    .end local v1    # "metadataImageReader":Landroidx/camera/core/MetadataImageReader;
    :goto_0
    new-instance v1, Landroidx/camera/core/ImageCapture$ImageCaptureRequestProcessor;

    new-instance v3, Landroidx/camera/core/-$$Lambda$ImageCapture$0LGjmnFUtCxVzUuUHAMaY4_BMjw;

    invoke-direct {v3, p0}, Landroidx/camera/core/-$$Lambda$ImageCapture$0LGjmnFUtCxVzUuUHAMaY4_BMjw;-><init>(Landroidx/camera/core/ImageCapture;)V
    ...
    .line 361
    .local v1, "imageReaderProxy":Landroidx/camera/core/SafeCloseImageReaderProxy;
    ...
    new-instance v3, Landroidx/camera/core/-$$Lambda$kBKr-WXSgibOrSk3AWcyOrTIBI0;

    invoke-direct {v3, v1}, Landroidx/camera/core/-$$Lambda$kBKr-WXSgibOrSk3AWcyOrTIBI0;-><init>(Landroidx/camera/core/SafeCloseImageReaderProxy;)V
    ...
    invoke-virtual {v0, v2}, Landroidx/camera/core/impl/SessionConfig$Builder;->addNonRepeatingSurface(Landroidx/camera/core/impl/DeferrableSurface;)V

    .line 369
    new-instance v2, Landroidx/camera/core/-$$Lambda$ImageCapture$vo2FN-NBh2zJowDghO6l4OnBl-M;

    invoke-direct {v2, p0, p1, p2, p3}, Landroidx/camera/core/-$$Lambda$ImageCapture$vo2FN-NBh2zJowDghO6l4OnBl-M;-><init>(Landroidx/camera/core/ImageCapture;Ljava/lang/String;Landroidx/camera/core/impl/ImageCaptureConfig;Landroid/util/Size;)V

    invoke-virtual {v0, v2}, Landroidx/camera/core/impl/SessionConfig$Builder;->addErrorListener(Landroidx/camera/core/impl/SessionConfig$ErrorListener;)V
...
.method public getDefaultBuilder(Landroidx/camera/core/CameraInfo;)Landroidx/camera/core/impl/UseCaseConfig$Builder;
    ...
    .line 413
    .local v0, "defaults":Landroidx/camera/core/impl/ImageCaptureConfig;
    if-eqz v0, :cond_0
...
.method issueTakePicture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1230
    .local v1, "captureConfigs":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureConfig;>;"
    ...
    const-string v4, "ImageCapture has CaptureStages > Max CaptureStage size"
    ...
    .line 1247
    .end local v2    # "captureBundle":Landroidx/camera/core/impl/CaptureBundle;
    :cond_3
    invoke-static {}, Landroidx/camera/core/CaptureBundles;->singleDefaultCaptureBundle()Landroidx/camera/core/impl/CaptureBundle;
    ...
    .line 1248
    .restart local v2    # "captureBundle":Landroidx/camera/core/impl/CaptureBundle;
    invoke-interface {v2}, Landroidx/camera/core/impl/CaptureBundle;->getCaptureStages()Ljava/util/List;
    ...
    const-string v4, "ImageCapture have no CaptureProcess set with CaptureBundle size > 1."
    ...
    .line 1255
    .local v4, "captureStage":Landroidx/camera/core/impl/CaptureStage;
    ...
    .line 1256
    .local v5, "builder":Landroidx/camera/core/impl/CaptureConfig$Builder;
    ...
    invoke-virtual {v6}, Landroidx/camera/core/impl/CaptureConfig;->getTag()Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v5, v6}, Landroidx/camera/core/impl/CaptureConfig$Builder;->setTag(Ljava/lang/Object;)V
    ...
    .line 1277
    new-instance v6, Landroidx/camera/core/-$$Lambda$ImageCapture$GXGyp2twiJatfd77vWgGABw5Y6Y;

    invoke-direct {v6, p0, v5, v1, v4}, Landroidx/camera/core/-$$Lambda$ImageCapture$GXGyp2twiJatfd77vWgGABw5Y6Y;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/impl/CaptureConfig$Builder;Ljava/util/List;Landroidx/camera/core/impl/CaptureStage;)V
    ...
    .line 1306
    .local v6, "future":Lcom/google/common/util/concurrent/ListenableFuture;, "Lcom/google/common/util/concurrent/ListenableFuture<Ljava/lang/Void;>;"
    invoke-interface {v0, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 1308
    .end local v4    # "captureStage":Landroidx/camera/core/impl/CaptureStage;
    .end local v5    # "builder":Landroidx/camera/core/impl/CaptureConfig$Builder;
    .end local v6    # "future":Lcom/google/common/util/concurrent/ListenableFuture;, "Lcom/google/common/util/concurrent/ListenableFuture<Ljava/lang/Void;>;"
    goto :goto_1
    ...
    invoke-interface {v3, v1}, Landroidx/camera/core/impl/CameraControlInternal;->submitCaptureRequests(Ljava/util/List;)V
    ...
    sget-object v4, Landroidx/camera/core/-$$Lambda$ImageCapture$b_FiC4cqL3qwcK1Cdd08YNsRUTk;->INSTANCE:Landroidx/camera/core/-$$Lambda$ImageCapture$b_FiC4cqL3qwcK1Cdd08YNsRUTk;
    ...
    .line 1311
    invoke-static {v3, v4, v5}, Landroidx/camera/core/impl/utils/futures/Futures;->transform(Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/arch/core/util/Function;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public synthetic lambda$createPipeline$1$ImageCapture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .param p1, "request"    # Landroidx/camera/core/ImageCapture$ImageCaptureRequest;
...
.method public synthetic lambda$createPipeline$2$ImageCapture(Ljava/lang/String;Landroidx/camera/core/impl/ImageCaptureConfig;Landroid/util/Size;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/SessionConfig$SessionError;)V
    .locals 1
    .param p1, "cameraId"    # Ljava/lang/String;
    .param p2, "config"    # Landroidx/camera/core/impl/ImageCaptureConfig;
    .param p3, "resolution"    # Landroid/util/Size;
...
.method public synthetic lambda$issueTakePicture$14$ImageCapture(Landroidx/camera/core/impl/CaptureConfig$Builder;Ljava/util/List;Landroidx/camera/core/impl/CaptureStage;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 3
    .param p1, "builder"    # Landroidx/camera/core/impl/CaptureConfig$Builder;
    .param p2, "captureConfigs"    # Ljava/util/List;
    .param p3, "captureStage"    # Landroidx/camera/core/impl/CaptureStage;
    ...
    .line 1301
    .local v0, "completerCallback":Landroidx/camera/core/impl/CameraCaptureCallback;
    ...
    const-string v2, "issueTakePicture[stage="
...
.method public synthetic lambda$preTakePicture$10$ImageCapture(Landroidx/camera/core/ImageCapture$TakePictureState;Landroidx/camera/core/impl/CameraCaptureResult;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .param p1, "state"    # Landroidx/camera/core/ImageCapture$TakePictureState;
...
.method public synthetic lambda$preTakePicture$11$ImageCapture(Landroidx/camera/core/ImageCapture$TakePictureState;Landroidx/camera/core/impl/CameraCaptureResult;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .param p1, "state"    # Landroidx/camera/core/ImageCapture$TakePictureState;
    .param p2, "v"    # Landroidx/camera/core/impl/CameraCaptureResult;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
        }
...
.method public synthetic lambda$sendImageCaptureRequest$5$ImageCapture(Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
    .locals 4
    .param p1, "callback"    # Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;
...
.method public synthetic lambda$takePicture$3$ImageCapture(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
    .locals 0
...
.method public synthetic lambda$takePicture$4$ImageCapture(Landroidx/camera/core/ImageCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageSavedCallback;)V
    .locals 0
...
.method public synthetic lambda$takePictureInternal$7$ImageCapture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;Ljava/lang/Void;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .param p1, "imageCaptureRequest"    # Landroidx/camera/core/ImageCapture$ImageCaptureRequest;
...
.method public synthetic lambda$takePictureInternal$9$ImageCapture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 4
    .param p1, "imageCaptureRequest"    # Landroidx/camera/core/ImageCapture$ImageCaptureRequest;
    ...
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$gAHopxs-tnQYHzPHmR3kdJ2NWgQ;

    invoke-direct {v1, p2}, Landroidx/camera/core/-$$Lambda$ImageCapture$gAHopxs-tnQYHzPHmR3kdJ2NWgQ;-><init>(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    .line 809
    .local v0, "state":Landroidx/camera/core/ImageCapture$TakePictureState;
    ...
    new-instance v2, Landroidx/camera/core/-$$Lambda$ImageCapture$Q2natJasV8R7bZpCzT-XPmy4R_4;

    invoke-direct {v2, p0, p1}, Landroidx/camera/core/-$$Lambda$ImageCapture$Q2natJasV8R7bZpCzT-XPmy4R_4;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)V

    iget-object v3, p0, Landroidx/camera/core/ImageCapture;->mExecutor:Ljava/util/concurrent/ExecutorService;
    ...
    new-instance v2, Landroidx/camera/core/ImageCapture$5;

    invoke-direct {v2, p0, v0, p2}, Landroidx/camera/core/ImageCapture$5;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$TakePictureState;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    .line 828
    new-instance v2, Landroidx/camera/core/-$$Lambda$ImageCapture$NOvpRrsYSzBN1_Z8IEVaCXMxXwc;

    invoke-direct {v2, v1}, Landroidx/camera/core/-$$Lambda$ImageCapture$NOvpRrsYSzBN1_Z8IEVaCXMxXwc;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    .line 828
    invoke-virtual {p2, v2, v3}, Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;->addCancellationListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public setCropAspectRatio(Landroid/util/Rational;)V
    ...
    .line 503
    .local v0, "oldConfig":Landroidx/camera/core/impl/ImageCaptureConfig;
    invoke-static {v0}, Landroidx/camera/core/ImageCapture$Builder;->fromConfig(Landroidx/camera/core/impl/ImageCaptureConfig;)Landroidx/camera/core/ImageCapture$Builder;

    move-result-object v1

    .line 504
    .local v1, "builder":Landroidx/camera/core/ImageCapture$Builder;
    iget-object v2, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Landroidx/camera/core/impl/ImageCaptureConfig;->getTargetAspectRatioCustom(Landroid/util/Rational;)Landroid/util/Rational;

    move-result-object v2

    .line 505
    .local v2, "oldRatio":Landroid/util/Rational;
    ...
    .line 506
    invoke-virtual {v1, p1}, Landroidx/camera/core/ImageCapture$Builder;->setTargetAspectRatioCustom(Landroid/util/Rational;)Landroidx/camera/core/ImageCapture$Builder;
    ...
    invoke-virtual {p0, v3}, Landroidx/camera/core/ImageCapture;->updateUseCaseConfig(Landroidx/camera/core/impl/UseCaseConfig;)V
    ...
    iput-object v3, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;
...
.method public setTargetRotation(I)V
    ...
    invoke-virtual {p0, v2}, Landroidx/camera/core/ImageCapture;->updateUseCaseConfig(Landroidx/camera/core/impl/UseCaseConfig;)V
    ...
    iput-object v2, p0, Landroidx/camera/core/ImageCapture;->mUserSettingConfig:Landroidx/camera/core/impl/ImageCaptureConfig;
...
.method public takePicture(Landroidx/camera/core/ImageCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageSavedCallback;)V
    ...
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$GKCJoIxQ7x6CHqe5VLbTJu0vu5E;

    invoke-direct {v1, p0, p1, p2, p3}, Landroidx/camera/core/-$$Lambda$ImageCapture$GKCJoIxQ7x6CHqe5VLbTJu0vu5E;-><init>(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$OutputFileOptions;Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageSavedCallback;)V
    ...
    .line 684
    .local v6, "imageSavedCallbackWrapper":Landroidx/camera/core/ImageSaver$OnImageSavedCallback;
    ...
    .line 705
    .local v0, "imageCaptureCallbackWrapper":Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;
    invoke-static {}, Landroidx/camera/core/impl/utils/executor/CameraXExecutors;->mainThreadExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    invoke-direct {p0, v1, v0}, Landroidx/camera/core/ImageCapture;->sendImageCaptureRequest(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
...
.method public takePicture(Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
    ...
    new-instance v1, Landroidx/camera/core/-$$Lambda$ImageCapture$3TBxQKmNJ9VTGCKo1ZKi7E3ESgI;

    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/core/-$$Lambda$ImageCapture$3TBxQKmNJ9VTGCKo1ZKi7E3ESgI;-><init>(Landroidx/camera/core/ImageCapture;Ljava/util/concurrent/Executor;Landroidx/camera/core/ImageCapture$OnImageCapturedCallback;)V
