...
.method public onClosed(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    const-string v2, "CameraCaptureSession.onClosed()"
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/CaptureSession;->finishClose()V
    ...
    const-string v3, "onClosed() should not be possible in state: "
    ...
    .end local p1    # "session":Landroidx/camera/camera2/internal/SynchronizedCaptureSession;
    throw v1

    .line 863
    .restart local p1    # "session":Landroidx/camera/camera2/internal/SynchronizedCaptureSession;
    :catchall_0
    move-exception v1
...
.method public onConfigured(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    invoke-direct {v2, v1}, Landroidx/camera/camera2/impl/Camera2ImplConfig;-><init>(Landroidx/camera/core/impl/Config;)V
    ...
    .line 818
    .local v2, "eventCallbacks":Landroidx/camera/camera2/impl/CameraEventCallbacks;
    nop
    ...
    invoke-virtual {v3}, Landroidx/camera/camera2/impl/CameraEventCallbacks$ComboCameraEventCallback;->onEnableSession()Ljava/util/List;

    move-result-object v3

    .line 820
    .local v3, "list":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureConfig;>;"
    ...
    iget-object v5, p0, Landroidx/camera/camera2/internal/CaptureSession$StateCallback;->this$0:Landroidx/camera/camera2/internal/CaptureSession;

    invoke-virtual {v5, v3}, Landroidx/camera/camera2/internal/CaptureSession;->setupConfiguredSurface(Ljava/util/List;)Ljava/util/List;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroidx/camera/camera2/internal/CaptureSession;->issueBurstCaptureRequest(Ljava/util/List;)V

    .line 825
    .end local v1    # "implOptions":Landroidx/camera/core/impl/Config;
    .end local v2    # "eventCallbacks":Landroidx/camera/camera2/impl/CameraEventCallbacks;
    .end local v3    # "list":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureConfig;>;"
    :cond_0
    const-string v1, "CaptureSession"
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/CaptureSession;->issueRepeatingCaptureRequests()V

    .line 827
    iget-object v1, p0, Landroidx/camera/camera2/internal/CaptureSession$StateCallback;->this$0:Landroidx/camera/camera2/internal/CaptureSession;

    invoke-virtual {v1}, Landroidx/camera/camera2/internal/CaptureSession;->issuePendingCaptureRequest()V
